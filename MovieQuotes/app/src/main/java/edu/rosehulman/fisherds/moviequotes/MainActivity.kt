...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var mAdapter: MovieQuotesAdapter
    ...
    override fun onStop() {
        super.onStop()
        mAdapter.removeSnapshotListener()
    }
